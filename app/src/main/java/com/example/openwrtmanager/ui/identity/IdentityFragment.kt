...
class IdentityFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val identityViewModel = ViewModelProvider(requireActivity(), viewModelFactory).get(IdentityViewModel::class.java)
        ...
        identityViewModel.todoLiveData.observe(
            viewLifecycleOwner,
            Observer { todos: List<IdentityItem> -> adapter.submitList(todos) })
